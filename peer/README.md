...
(http://godoc.org/github.com/litecoinfinance/ltfnd/peer)
...
```bash
$ go get -u github.com/litecoinfinance/ltfnd/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/litecoinfinance/ltfnd/peer#example-package--NewOutboundPeer)  
