...
(http://godoc.org/github.com/litecoinfinance/ltcd/peer)
...
```bash
$ go get -u github.com/litecoinfinance/ltcd/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/litecoinfinance/ltcd/peer#example-package--NewOutboundPeer)  
