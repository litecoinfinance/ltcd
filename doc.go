...
/*
ltfnd is a full-node bitcoin implementation written in Go.

The default options are sane for most users.  This means ltfnd will work 'out of
...
parsed when ltfnd starts up.  By default, the configuration file is located at
~/.ltfnd/ltfnd.conf on POSIX-style operating systems and %LOCALAPPDATA%\ltfnd\ltfnd.conf
...
Application Options:
  ...
  -a, --addpeer=            Add a peer to connect with at startup
      ...
      --listen=             Add an interface/port to listen for connections
                            (default all interfaces port: 39328, testnet: 19333)
  ...
  -P, --rpcpass=            Password for RPC connections
      ...
      --rpclisten=          Add an interface/port to listen for RPC connections
                            (default port: 39329, testnet: 19334)
