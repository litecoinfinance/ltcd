...
func GetBlockWeight(blk *ltfnutil.Block) int64 {
...
func GetTransactionWeight(tx *ltfnutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *ltfnutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
