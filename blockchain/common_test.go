...
// ltfnutil.Block.  This is largely borrowed from the test code in ltfndb.
func loadBlocks(filename string) (blocks []*ltfnutil.Block, err error) {
	...
	for height := int64(1); err == nil; height++ {
		...
		block, err = ltfnutil.NewBlockFromBytes(rbytes)
		if err != nil {
			return
		}
