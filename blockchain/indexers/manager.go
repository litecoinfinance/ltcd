...
func dbIndexConnectBlock(dbTx database.Tx, indexer Indexer, block *ltfnutil.Block,
...
func dbIndexDisconnectBlock(dbTx database.Tx, indexer Indexer, block *ltfnutil.Block,
	stxo []blockchain.SpentTxOut) error {
...
//
// This is part of the blockchain.IndexManager interface.
func (m *Manager) ConnectBlock(dbTx database.Tx, block *ltfnutil.Block,
...
//
// This is part of the blockchain.IndexManager interface.
func (m *Manager) DisconnectBlock(dbTx database.Tx, block *ltfnutil.Block,
	stxo []blockchain.SpentTxOut) error {
