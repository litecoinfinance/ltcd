...
func (view *UtxoViewpoint) AddTxOut(tx *ltfnutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *ltfnutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *ltfnutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *ltfnutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *ltfnutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *ltfnutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *ltfnutil.Tx) (*UtxoViewpoint, error) {
