...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*ltfnutil.Block, error) {
	...
	blocks := make([]*ltfnutil.Block, 0, 256)
	genesis := ltfnutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
