...
func addNaTests() {
	// IPv4
	// Localhost
	addNaTest("127.0.0.1", 39328, "127.0.0.1:39328")
	addNaTest("127.0.0.1", 39329, "127.0.0.1:39329")

	// Class A
	addNaTest("1.0.0.1", 39328, "1.0.0.1:39328")
	addNaTest("2.2.2.2", 39329, "2.2.2.2:39329")
	addNaTest("27.253.252.251", 9335, "27.253.252.251:9335")
	addNaTest("123.3.2.1", 9336, "123.3.2.1:9336")

	// Private Class A
	addNaTest("10.0.0.1", 39328, "10.0.0.1:39328")
	addNaTest("10.1.1.1", 39329, "10.1.1.1:39329")
	addNaTest("10.2.2.2", 9335, "10.2.2.2:9335")
	addNaTest("10.10.10.10", 9336, "10.10.10.10:9336")

	// Class B
	addNaTest("128.0.0.1", 39328, "128.0.0.1:39328")
	addNaTest("129.1.1.1", 39329, "129.1.1.1:39329")
	addNaTest("180.2.2.2", 9335, "180.2.2.2:9335")
	addNaTest("191.10.10.10", 9336, "191.10.10.10:9336")

	// Private Class B
	addNaTest("172.16.0.1", 39328, "172.16.0.1:39328")
	addNaTest("172.16.1.1", 39329, "172.16.1.1:39329")
	addNaTest("172.16.2.2", 9335, "172.16.2.2:9335")
	addNaTest("172.16.172.172", 9336, "172.16.172.172:9336")

	// Class C
	addNaTest("193.0.0.1", 39328, "193.0.0.1:39328")
	addNaTest("200.1.1.1", 39329, "200.1.1.1:39329")
	addNaTest("205.2.2.2", 9335, "205.2.2.2:9335")
	addNaTest("223.10.10.10", 9336, "223.10.10.10:9336")

	// Private Class C
	addNaTest("192.168.0.1", 39328, "192.168.0.1:39328")
	addNaTest("192.168.1.1", 39329, "192.168.1.1:39329")
	addNaTest("192.168.2.2", 9335, "192.168.2.2:9335")
	addNaTest("192.168.192.192", 9336, "192.168.192.192:9336")

	// IPv6
	// Localhost
	addNaTest("::1", 39328, "[::1]:39328")
	addNaTest("fe80::1", 39329, "[fe80::1]:39329")

	// Link-local
	addNaTest("fe80::1:1", 39328, "[fe80::1:1]:39328")
	addNaTest("fe91::2:2", 39329, "[fe91::2:2]:39329")
	addNaTest("fea2::3:3", 9335, "[fea2::3:3]:9335")
	addNaTest("feb3::4:4", 9336, "[feb3::4:4]:9336")

	// Site-local
	addNaTest("fec0::1:1", 39328, "[fec0::1:1]:39328")
	addNaTest("fed1::2:2", 39329, "[fed1::2:2]:39329")
...
func TestAttempt(t *testing.T) {
	...
	err := n.AddAddressByIP(someIP + ":39328")
	if err != nil {
...
func TestNeedMoreAddresses(t *testing.T) {
	...
	for i := 0; i < addrsToAdd; i++ {
		s := fmt.Sprintf("%d.%d.173.147:39328", i/128+60, i%128+60)
	...
	srcAddr := wire.NewNetAddressIPPort(net.IPv4(173, 144, 173, 111), 39328, 0)
...
func TestGood(t *testing.T) {
	...
	var err error
	for i := 0; i < addrsToAdd; i++ {
		s := fmt.Sprintf("%d.173.147.%d:39328", i/64+60, i%64+60)
		addrs[i], err = n.DeserializeNetAddress(s)
		if err != nil {
			t.Errorf("Failed to turn %s into an address: %v", s, err)
		}
