...
func (c *Client) SubmitBlockAsync(block *ltfnutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *ltfnutil.Block, options *btcjson.SubmitBlockOptions) error {
