...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []ltfnutil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []ltfnutil.Address) ([]btcjson.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee ltfnutil.Amount) FutureSetTxFeeResult {
...
func (c *Client) SetTxFee(fee ltfnutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address ltfnutil.Address, amount ltfnutil.Amount) FutureSendToAddressResult {
...
func (c *Client) SendToAddress(address ltfnutil.Address, amount ltfnutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address ltfnutil.Address,
	amount ltfnutil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address ltfnutil.Address, amount ltfnutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress ltfnutil.Address, amount ltfnutil.Amount) FutureSendFromResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress ltfnutil.Address, amount ltfnutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress ltfnutil.Address, amount ltfnutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress ltfnutil.Address, amount ltfnutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress ltfnutil.Address, amount ltfnutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress ltfnutil.Address,
	amount ltfnutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[ltfnutil.Address]ltfnutil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[ltfnutil.Address]ltfnutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[ltfnutil.Address]ltfnutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[ltfnutil.Address]ltfnutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (ltfnutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return ltfnutil.DecodeAddress(addr, &chaincfg.MainNetParams)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []ltfnutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []ltfnutil.Address, account string) (ltfnutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []ltfnutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []ltfnutil.Address) (*btcjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (ltfnutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddress(account string) (ltfnutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (ltfnutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (ltfnutil.Address, error) {
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (ltfnutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddWitnessAddress(address string) (ltfnutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (ltfnutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (ltfnutil.Address, error) {
...
func (c *Client) GetAccountAsync(address ltfnutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address ltfnutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address ltfnutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address ltfnutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]ltfnutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]ltfnutil.Address, 0, len(addrStrings))
	for _, addrStr := range addrStrings {
		addr, err := ltfnutil.DecodeAddress(addrStr,
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]ltfnutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount ltfnutil.Amount) FutureMoveResult {
...
func (c *Client) Move(fromAccount, toAccount string, amount ltfnutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount ltfnutil.Amount, minConfirms int) FutureMoveResult {
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount ltfnutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount ltfnutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount ltfnutil.Amount,
...
func (c *Client) ValidateAddressAsync(address ltfnutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) ValidateAddress(address ltfnutil.Address) (*btcjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]ltfnutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]ltfnutil.Amount)
	for k, v := range accounts {
		amount, err := ltfnutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]ltfnutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]ltfnutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (ltfnutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := ltfnutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (ltfnutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (ltfnutil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (ltfnutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (ltfnutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (ltfnutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (ltfnutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (ltfnutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (ltfnutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (ltfnutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address ltfnutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address ltfnutil.Address) (ltfnutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address ltfnutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address ltfnutil.Address, minConfirms int) (ltfnutil.Amount, error) {
...
func (c *Client) SignMessageAsync(address ltfnutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address ltfnutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address ltfnutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address ltfnutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*ltfnutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return ltfnutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address ltfnutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address ltfnutil.Address) (*ltfnutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *ltfnutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *ltfnutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *ltfnutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *ltfnutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *ltfnutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *ltfnutil.WIF, label string, rescan bool) error {
...
// NOTE: While getinfo is implemented here (in wallet.go), a ltfnd chain server
