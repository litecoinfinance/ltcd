...
// reference implementation because ltfnd does not handle wallet requests.  The
// separate wallet process listens on the well-known port and forwards requests
// it does not handle on to ltfnd.  This approach allows the wallet process
...
// time of writing, ltfnd currently places blocks for testnet version 3 in the
