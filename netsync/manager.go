...
import (
	...
	peerpkg "github.com/litecoinfinance/ltfnd/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*ltfnutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *ltfnutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *ltfnutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *ltfnutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
