...
reason, the ltfnd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire ltfnd
...
One of the major design goals of all core ltfnd packages is to aim for complete
...
commits](https://github.com/litecoinfinance/ltfnd/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into ltfnd.
...
Rejoice as you will now be listed as a [contributor](https://github.com/litecoinfinance/ltfnd/graphs/contributors)!
...
[ISC license](https://github.com/litecoinfinance/ltfnd/blob/master/LICENSE).  This is
the same license as all of the code in the ltfnd suite.
