...
* Install the MSI available at: https://github.com/litecoinfinance/ltcd/releases
...
$ git clone https://github.com/litecoinfinance/ltcd $GOPATH/src/github.com/litecoinfinance/ltcd
$ cd $GOPATH/src/github.com/litecoinfinance/ltcd
...
ltcd has a number of [configuration](http://godoc.org/github.com/litecoinfinance/ltcd)
...
* [Using bootstrap.dat](https://github.com/litecoinfinance/ltcd/tree/master/docs/using_bootstrap_dat.md)

<a name="NetworkConfig" />

**3.1.2 Network Configuration**

* [What Ports Are Used by Default?](https://github.com/litecoinfinance/ltcd/tree/master/docs/default_ports.md)
* [How To Listen on Specific Interfaces](https://github.com/litecoinfinance/ltcd/tree/master/docs/configure_peer_server_listen_interfaces.md)
* [How To Configure RPC Server to Listen on Specific Interfaces](https://github.com/litecoinfinance/ltcd/tree/master/docs/configure_rpc_server_listen_interfaces.md)
* [Configuring ltcd with Tor](https://github.com/litecoinfinance/ltcd/tree/master/docs/configuring_tor.md)
...
* [Code Contribution Guidelines](https://github.com/litecoinfinance/ltcd/tree/master/docs/code_contribution_guidelines.md)

<a name="JSONRPCReference" />

* [JSON-RPC Reference](https://github.com/litecoinfinance/ltcd/tree/master/docs/json_rpc_api.md)
    * [RPC Examples](https://github.com/litecoinfinance/ltcd/tree/master/docs/json_rpc_api.md#ExampleCode)
...
* The ltcsuite Litecoinfinance-related Go Packages:
    ...
    * [wire](https://github.com/litecoinfinance/ltcd/tree/master/wire) - Implements the
      Bitcoin wire protocol
    * [peer](https://github.com/litecoinfinance/ltcd/tree/master/peer) -
      Provides a common base for creating and managing Bitcoin network peers.
    * [blockchain](https://github.com/litecoinfinance/ltcd/tree/master/blockchain) -
      Implements Bitcoin block handling and chain selection rules
    * [blockchain/fullblocktests](https://github.com/litecoinfinance/ltcd/tree/master/blockchain/fullblocktests) -
      Provides a set of block tests for testing the consensus validation rules
    * [txscript](https://github.com/litecoinfinance/ltcd/tree/master/txscript) -
      Implements the Bitcoin transaction scripting language
    * [btcec](https://github.com/litecoinfinance/ltcd/tree/master/btcec) - Implements
      support for the elliptic curve cryptographic functions needed for the
      Bitcoin scripts
    * [database](https://github.com/litecoinfinance/ltcd/tree/master/database) -
      Provides a database interface for the Bitcoin block chain
    * [mempool](https://github.com/litecoinfinance/ltcd/tree/master/mempool) -
      Package mempool provides a policy-enforced pool of unmined bitcoin
      transactions.
    * [btcutil](https://github.com/litecoinfinance/ltcutil) - Provides Bitcoin-specific
      convenience functions and types
    * [chainhash](https://github.com/litecoinfinance/ltcd/tree/master/chaincfg/chainhash) -
      Provides a generic hash type and associated functions that allows the
      specific hash algorithm to be abstracted.
    * [connmgr](https://github.com/litecoinfinance/ltcd/tree/master/connmgr) -
