...
(http://godoc.org/github.com/litecoinfinance/ltfnd/chaincfg)
...
func main() {
	...
	addr, err := ltfnutil.NewAddressPubKeyHash(pubKeyHash, chainParams)
	if err != nil {
		log.Fatal(err)
	}
	fmt.Println(addr)
...
```bash
$ go get -u github.com/litecoinfinance/ltfnd/chaincfg
```
