...
func TestVersion(t *testing.T) {
	...
	tcpAddrMe := &net.TCPAddr{IP: net.ParseIP("127.0.0.1"), Port: 39328}
	me := NewNetAddress(tcpAddrMe, SFNodeNetwork)
	tcpAddrYou := &net.TCPAddr{IP: net.ParseIP("192.168.0.1"), Port: 39328}
...
func TestVersionOptionalFields(t *testing.T) {
	...
	uaVersion.UserAgent = "/ltfndtest:0.0.1/"
...
var baseVersionEncoded = []byte{
	...
	0x20, 0x8d, // Port 39328 in big-endian
